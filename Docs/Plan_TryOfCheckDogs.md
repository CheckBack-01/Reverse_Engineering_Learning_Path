...
* **TOCD Segment 1:** **2025-08-14 → 2026-09-14**
  ...
  **Parallel track:** **Phase 0 (Applied Cryptomath)** runs **in parallel with Phase 1** from **2025-08-21 → \~2025-10-05**, at **3–4 sessions/week (60–75 min)**. After completion, keep a light **refresh (20–30 min, 1–2×/week)** inside BackLogs.
...
0. **Phase 0 (parallel micro-track):** short, non-daily cryptomath track supporting Phase 1. 3–4 sessions/week, 60–75 min, \~6 weeks total; afterward maintained via BackLogs.
...
* **Phase 0 — Applied Cryptomath (runs in parallel with Phase 1; short, non-daily cadence)**
  Base conversions (bin/dec/hex, two’s complement), **modular arithmetic** (ops, inverses, Fermat in practice), essentials of **number theory** (primes, gcd/lcm, factorization) and minimal linear algebra for block representations (**Hill-lite**).
  **Cadence:** 3–4 sessions/week, 60–75 min each, for \~6 weeks. **Deliverables:** PBR mini-labs + PAD-lite; evidence and manifests like the other phases. **Purpose:** accelerate F1 comprehension (tooling, binaries) without overloading the daily schedule.
...
* **Before university:** 5 h/day, Mon–Sat, on TOCD mainline (F1+).
  **Plus:** during the first \~6 weeks (**2025-08-21 → \~2025-10-05**), allocate **60–75 min on 3–4 days/week** for **Phase 0** in parallel with F1. After F0 completes, maintain skills via BackLogs (20–30 min, 1–2×/week).
...
**F0 micro-KPIs (speed + accuracy)**

* Base-conversion drills (50-item set): **≥95% accuracy** under time cap.
* Modular arithmetic set (20 items / 10 min): **≥90% accuracy**.
* gcd/lcm “one-liners” (Euclid) and quick checks for prime factorization on small integers.
* One **mini PBR** per topic with manifest and reproducible evidence.

### **8) BackLogs during university**

During the 9-month bug bounty + university period, maintain TOCD with **6–8 h/week BackLogs**, including **F0 refreshers (20–30 min, 1–2×/week)** to prevent skill decay:
...
* **2025-08-14 → 2026-09-14:** Continuous TOCD (5 h/day).
  • **2025-08-21 → \~2025-10-05:** **Phase 0 (Applied Cryptomath)** in parallel with **Phase 1**, 3–4 sessions/week (60–75 min).
