...
> **Parallel note:** **Phase 0 (Applied Cryptomath)** runs **alongside Phase 1** from **2025-08-21 → \~2025-10-05**, **3–4 sessions/week (60–75 min)**. It does **not** materially change the daily time budget.

### 1) Phase summary (brief)

**Phase 0 — Cryptomath (parallel micro-track)**
Base conversions (bin/dec/hex, two’s complement), **modular arithmetic** (ops, inverses, Fermat in practice), essentials of **number theory** (primes, gcd/lcm, factorization), and minimal linear algebra for block representations (**Hill-lite**). Outcome: accelerated comprehension for F1 topics; **3 mini-PBRs** (Conversions, Modular Ops, Number-Theory Essentials) + **PAD-lite** (Hill-lite encoding) with manifests and evidence.
...
| --- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| C1  | 2025-08 → 2025-11 | **F0 (parallel):** Applied Cryptomath micro-track (base conversions, modular arithmetic, number-theory essentials, Hill-lite) **+** **F1:** B1 Linux/CLI/Bash · B2 Toolchain · start of B3 Systems C | **F0:** 3 mini-PBRs + PAD-lite with manifests/evidence; **F1:** scripting/toolchain PBRs; C utility with Makefile |
...
**F0**: Base conversions (bin/dec/hex, two’s complement) · Modular arithmetic (ops, inverses) · Number-theory essentials (primes, gcd/lcm, factorization) · Hill-lite block encoding (mini linear algebra)
...
* **F0:** 3 **mini-PBRs** (Conversions, Modular Ops, Number-Theory Essentials) with manifests/evidence + **PAD-lite** (Hill-lite encoding) and timed drill logs.
...
* **Phase 0 reminder:** short, non-daily, **2025-08-21 → \~2025-10-05**; maintained afterward via BackLogs (20–30 min, 1–2×/week).
...
* **F0 KPIs (micro):** ≥95% accuracy on 50-item conversion drills; ≥90% on 20-item modular sets (10 min cap); Euclid gcd/lcm one-liners; mini-PBRs closed with manifests/evidence.
